 ...
 ********************************************************************************************/
 uaa_size S2A_UA_1_send(buffer_el msg[], 
 ...
 ********************************************************************************************/
uaa_size S2A_UA_1_receive(buffer_el buffer[],  uaa_size buffer_size, 
  inC_S2A* scade_ctx,  extern_in_ctx_t * extern_ctx){
                  ...
                  case 3 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_SELECTION : 
                        ...
                        /*  Notify */
                        scade_ctx->SignalPortButton = kcg_true;
                        break;
                      default : break;
                    }
                    n = next_n;
 ...
 * Clear notifications                                                                      *
 ********************************************************************************************/
void S2A_UA_1_receive_clear(inC_S2A* scade_ctx,  extern_in_ctx_t * extern_ctx){
  scade_ctx->SignalPortButton = kcg_false;
}
