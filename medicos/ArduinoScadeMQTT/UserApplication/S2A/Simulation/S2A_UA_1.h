...
#ifndef S2A_UA_1_DEFAULT_CONTEXT_NUMBER
#define S2A_UA_1_DEFAULT_CONTEXT_NUMBER 0xDEFA
#endif

/* Input Buffer size (bytes) for data from the server */
#ifndef S2A_UA_1_MAX_SIZE_INPUT_BUFFER
#define S2A_UA_1_MAX_SIZE_INPUT_BUFFER 1000000UL
#endif

/* Output Buffer size (bytes) for data to send to the server */
#ifndef S2A_UA_1_MAX_SIZE_OUTPUT_BUFFER
#define S2A_UA_1_MAX_SIZE_OUTPUT_BUFFER 1000000UL
#endif
...
extern uaa_size S2A_UA_1_send(buffer_el msg[], outC_S2A* scade_ctx,
  extern_out_ctx_t* extern_out_ctx);

/* Receive notifications from the A661 server */
extern uaa_size S2A_UA_1_receive(buffer_el buffer[], uaa_size buffer_size,
  inC_S2A* scade_ctx, extern_in_ctx_t* extern_in_ctx);

/* Clear notifications */
extern void S2A_UA_1_receive_clear(inC_S2A* scade_ctx,
