...
const MappingEntry scope_1_entries[84] = {
    ...
    /* 17 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L1, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 17 },
    /* 18 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L2, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 18 },
    /* 19 */ { MAP_LOCAL, "_L3", NULL, sizeof(T_String), (size_t)&outputs_ctx._L3, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 19 },
    /* 20 */ { MAP_LOCAL, "_L4", NULL, sizeof(T_String), (size_t)&outputs_ctx._L4, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 20 },
    /* 21 */ { MAP_LOCAL, "_L5", NULL, sizeof(T_String), (size_t)&outputs_ctx._L5, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 21 },
    /* 22 */ { MAP_LOCAL, "_L6", NULL, sizeof(T_uChar), (size_t)&outputs_ctx._L6, &_Type_T_uChar_Utils, NULL, NULL, NULL, 1, 22 },
    /* 23 */ { MAP_LOCAL, "_L7", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L7, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 23 },
    /* 24 */ { MAP_LOCAL, "_L8", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L8, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 24 },
    /* 25 */ { MAP_LOCAL, "_L9", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L9, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 25 },
    /* 26 */ { MAP_LOCAL, "_L13", NULL, sizeof(T_uShort), (size_t)&outputs_ctx._L13, &_Type_T_uShort_Utils, NULL, NULL, NULL, 1, 26 },
    /* 27 */ { MAP_LOCAL, "_L12", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L12, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 27 },
    /* 28 */ { MAP_LOCAL, "_L11", NULL, sizeof(T_uShort), (size_t)&outputs_ctx._L11, &_Type_T_uShort_Utils, NULL, NULL, NULL, 1, 28 },
    /* 29 */ { MAP_LOCAL, "_L10", NULL, sizeof(T_uShort), (size_t)&outputs_ctx._L10, &_Type_T_uShort_Utils, NULL, NULL, NULL, 1, 29 },
    /* 30 */ { MAP_LOCAL, "_L19", NULL, sizeof(T_String), (size_t)&outputs_ctx._L19, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 30 },
    /* 31 */ { MAP_LOCAL, "_L27", NULL, sizeof(T_String), (size_t)&outputs_ctx._L27, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 31 },
    /* 32 */ { MAP_LOCAL, "_L30", NULL, sizeof(T_String), (size_t)&outputs_ctx._L30, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 32 },
    /* 33 */ { MAP_LOCAL, "_L31", NULL, sizeof(T_String), (size_t)&outputs_ctx._L31, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 33 },
    /* 34 */ { MAP_LOCAL, "_L32", NULL, sizeof(T_String), (size_t)&outputs_ctx._L32, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 34 },
    /* 35 */ { MAP_LOCAL, "_L42", NULL, sizeof(T_String), (size_t)&outputs_ctx._L42, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 35 },
    /* 36 */ { MAP_LOCAL, "_L91", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L91, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 36 },
    /* 37 */ { MAP_LOCAL, "_L99", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L99, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 37 },
    /* 38 */ { MAP_LOCAL, "_L100", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L100, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 38 },
    /* 39 */ { MAP_LOCAL, "_L108", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L108, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 39 },
    /* 40 */ { MAP_LOCAL, "_L112", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L112, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 40 },
    /* 41 */ { MAP_LOCAL, "_L117", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L117, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 41 },
    /* 42 */ { MAP_LOCAL, "_L116", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L116, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 42 },
    /* 43 */ { MAP_LOCAL, "_L114", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L114, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 43 },
    /* 44 */ { MAP_LOCAL, "_L113", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L113, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 44 },
    /* 45 */ { MAP_LOCAL, "_L118", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L118, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 45 },
    /* 46 */ { MAP_LOCAL, "_L119", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L119, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 46 },
    /* 47 */ { MAP_LOCAL, "_L120", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L120, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 47 },
    /* 48 */ { MAP_LOCAL, "_L130", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L130, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 48 },
    /* 49 */ { MAP_LOCAL, "_L129", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L129, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 49 },
    /* 50 */ { MAP_LOCAL, "_L128", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L128, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 50 },
    /* 51 */ { MAP_LOCAL, "_L127", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L127, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 51 },
    /* 52 */ { MAP_LOCAL, "_L124", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L124, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 52 },
    /* 53 */ { MAP_LOCAL, "_L123", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L123, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 53 },
    /* 54 */ { MAP_LOCAL, "_L122", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L122, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 54 },
    /* 55 */ { MAP_LOCAL, "_L121", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L121, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 55 },
    /* 56 */ { MAP_LOCAL, "_L131", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L131, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 56 },
    /* 57 */ { MAP_LOCAL, "_L132", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L132, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 57 },
    /* 58 */ { MAP_LOCAL, "_L146", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L146, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 58 },
    /* 59 */ { MAP_LOCAL, "_L143", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L143, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 59 },
    /* 60 */ { MAP_LOCAL, "_L139", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L139, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 60 },
    /* 61 */ { MAP_LOCAL, "_L136", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L136, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 61 },
    /* 62 */ { MAP_LOCAL, "_L149", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L149, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 62 },
    /* 63 */ { MAP_LOCAL, "_L150", NULL, sizeof(T_String), (size_t)&outputs_ctx._L150, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 63 },
    /* 64 */ { MAP_LOCAL, "_L152", NULL, sizeof(T_String), (size_t)&outputs_ctx._L152, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 64 },
    /* 65 */ { MAP_LOCAL, "_L297", NULL, sizeof(T_String), (size_t)&outputs_ctx._L297, &_Type_T_String_Utils, NULL, NULL, &scope_2, 1, 65 },
    /* 66 */ { MAP_LOCAL, "_L299", NULL, sizeof(kcg_float32), (size_t)&outputs_ctx._L299, &_Type_kcg_float32_Utils, NULL, NULL, NULL, 1, 66 },
    /* 67 */ { MAP_LOCAL, "_L300", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L300, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 67 },
    /* 68 */ { MAP_LOCAL, "_L301", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L301, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 68 },
    /* 69 */ { MAP_LOCAL, "_L302", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L302, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 69 },
    /* 70 */ { MAP_LOCAL, "_L312", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L312, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 70 },
    /* 71 */ { MAP_LOCAL, "_L311", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L311, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 71 },
    /* 72 */ { MAP_LOCAL, "_L310", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L310, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 72 },
    /* 73 */ { MAP_LOCAL, "_L309", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L309, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 73 },
    /* 74 */ { MAP_LOCAL, "_L314", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L314, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 74 },
    /* 75 */ { MAP_LOCAL, "_L322", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L322, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 75 },
    /* 76 */ { MAP_LOCAL, "_L321", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L321, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 76 },
    /* 77 */ { MAP_LOCAL, "_L320", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L320, &_Type_kcg_bool_Utils, NULL, NULL, NULL, 1, 77 },
    /* 78 */ { MAP_LOCAL, "_L319", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L319, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 78 },
    /* 79 */ { MAP_LOCAL, "_L317", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L317, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 79 },
    /* 80 */ { MAP_LOCAL, "_L316", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L316, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 80 },
    /* 81 */ { MAP_LOCAL, "_L315", NULL, sizeof(kcg_int32), (size_t)&outputs_ctx._L315, &_Type_kcg_int32_Utils, NULL, NULL, NULL, 1, 81 },
    /* 82 */ { MAP_EXPANDED, "Switch 1", NULL, 0, 0, NULL, NULL, NULL, &scope_3, 1, 82 },
    /* 83 */ { MAP_EXPANDED, "SpeedStr 1", NULL, 0, 0, NULL, NULL, NULL, &scope_4, 1, 83 }
};
