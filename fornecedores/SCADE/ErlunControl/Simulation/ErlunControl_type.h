#ifndef ERLUNCONTROL_TYPES_CONVERSION
#define ERLUNCONTROL_TYPES_CONVERSION
 ...
 ** T_uChar 
 ****************************************************************/
extern int T_uChar_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_T_uChar_string(const char *str, char **endptr);
extern int string_to_T_uChar(const char *str, void *pValue, char **endptr);
extern int is_T_uChar_double_conversion_allowed();
extern int T_uChar_to_double(const void *pValue, double *nValue);
extern int is_T_uChar_long_conversion_allowed();
extern int T_uChar_to_long(const void *pValue, long *nValue);
extern void compare_T_uChar(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_T_uChar_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_T_uChar_default_value(void *pValue);
extern int init_T_uChar(void *pValue);
extern int release_T_uChar(void *pValue);
extern int copy_T_uChar(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_T_uChar_Utils;

/****************************************************************
 ** T_uShort 
 ****************************************************************/
extern int T_uShort_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_T_uShort_string(const char *str, char **endptr);
extern int string_to_T_uShort(const char *str, void *pValue, char **endptr);
extern int is_T_uShort_double_conversion_allowed();
extern int T_uShort_to_double(const void *pValue, double *nValue);
extern int is_T_uShort_long_conversion_allowed();
extern int T_uShort_to_long(const void *pValue, long *nValue);
extern void compare_T_uShort(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_T_uShort_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_T_uShort_default_value(void *pValue);
extern int init_T_uShort(void *pValue);
extern int release_T_uShort(void *pValue);
extern int copy_T_uShort(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_T_uShort_Utils;


#endif /*ERLUNCONTROL_TYPES_CONVERSION */
