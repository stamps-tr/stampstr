#ifndef BATIMENTO_TYPES_CONVERSION
#define BATIMENTO_TYPES_CONVERSION
 ...
 ** array_uint32_5 
 ****************************************************************/
extern int array_uint32_5_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_array_uint32_5_string(const char *str, char **endptr);
extern int string_to_array_uint32_5(const char *str, void *pValue, char **endptr);
extern int is_array_uint32_5_double_conversion_allowed();
extern int array_uint32_5_to_double(const void *pValue, double *nValue);
extern int is_array_uint32_5_long_conversion_allowed();
extern int array_uint32_5_to_long(const void *pValue, long *nValue);
extern void compare_array_uint32_5(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_array_uint32_5_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_array_uint32_5_default_value(void *pValue);
extern SimTypeUtils _Type_array_uint32_5_Utils;
...
#endif /*BATIMENTO_TYPES_CONVERSION */
