...
static void _SCSIM_RestoreInterface(void) {
    inputs_ctx.SignalButtonPoor = inputs_ctx_restore.SignalButtonPoor;
    inputs_ctx.SignalButtonFair = inputs_ctx_restore.SignalButtonFair;
    inputs_ctx.SignalButtonGood = inputs_ctx_restore.SignalButtonGood;
    inputs_ctx.SignalButtonExcellent = inputs_ctx_restore.SignalButtonExcellent;
...
static void _SCSIM_ExecuteInterface(void) {
    ...
    inputs_ctx_execute.SignalButtonPoor = inputs_ctx.SignalButtonPoor;
    inputs_ctx_execute.SignalButtonFair = inputs_ctx.SignalButtonFair;
    inputs_ctx_execute.SignalButtonGood = inputs_ctx.SignalButtonGood;
    inputs_ctx_execute.SignalButtonExcellent = inputs_ctx.SignalButtonExcellent;
