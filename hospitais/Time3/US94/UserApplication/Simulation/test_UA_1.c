 ...
 ** 
 ** Date of generation: 2017-10-26T20:14:57
                  ...
                  case 18 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->DescriptionFromDisplay ",
                          EvtString_byte_size,
                          sizeof(scade_ctx->DescriptionFromDisplay));
                        a661_assign_string(scade_ctx->DescriptionFromDisplay,
                  ...
                  case 14 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->Longitude ",
                          EvtString_byte_size, sizeof(scade_ctx->Longitude));
                        a661_assign_string(scade_ctx->Longitude,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
                  ...
                  case 9 : 
                    ...
                    switch (READ_USHORT(( buffer + ( 2 + n ) ))){
                      case A661_EVT_STRING_CONFIRMED : 
                        ...
                        WIDGET("  ");
                        PARAMETER(" EvtString ");
                        CHECK_STRING_SIZE(" scade_ctx->Latitude ",
                          EvtString_byte_size, sizeof(scade_ctx->Latitude));
                        a661_assign_string(scade_ctx->Latitude,
                          ( buffer + ( 6 + n ) ), EvtString_byte_size);
                        break;
                      default : break;
                    }
...
/*********************************************************
 ** End of file
 ** End of generation: 2017-10-26T20:14:57
 *********************************************************/
