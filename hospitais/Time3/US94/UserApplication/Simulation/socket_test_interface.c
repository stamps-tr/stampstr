...
const char* _SCSIM_CheckSum = "8c6ac7197643a9c036b4385e71f94316";
...
static void _SCSIM_RestoreInterface(void) {
    kcg_copy_array_char_150(&(inputs_ctx.DescriptionFromDisplay), &(inputs_ctx_restore.DescriptionFromDisplay));
    inputs_ctx.SignalFromButton = inputs_ctx_restore.SignalFromButton;
    kcg_copy_array_char_10(&(inputs_ctx.Latitude), &(inputs_ctx_restore.Latitude));
    kcg_copy_array_char_10(&(inputs_ctx.Longitude), &(inputs_ctx_restore.Longitude));
...
static void _SCSIM_ExecuteInterface(void) {
    ...
    kcg_copy_array_char_150(&(inputs_ctx_execute.DescriptionFromDisplay), &(inputs_ctx.DescriptionFromDisplay));
    inputs_ctx_execute.SignalFromButton = inputs_ctx.SignalFromButton;
    kcg_copy_array_char_10(&(inputs_ctx_execute.Latitude), &(inputs_ctx.Latitude));
    kcg_copy_array_char_10(&(inputs_ctx_execute.Longitude), &(inputs_ctx.Longitude));
