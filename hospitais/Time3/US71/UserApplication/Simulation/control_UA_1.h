 ...
 ** 
 ** Date of generation: 2017-10-18T23:50:55
 ...
 *********************************************************/
#ifndef _CONTROL_UA_1_H_
#define _CONTROL_UA_1_H_ 
...
#ifndef control_UA_1_DEFAULT_CONTEXT_NUMBER
#define control_UA_1_DEFAULT_CONTEXT_NUMBER 0xDEFA
#endif

/* Input Buffer size (bytes) for data from the server */
#ifndef control_UA_1_MAX_SIZE_INPUT_BUFFER
#define control_UA_1_MAX_SIZE_INPUT_BUFFER 1000000UL
#endif

/* Output Buffer size (bytes) for data to send to the server */
#ifndef control_UA_1_MAX_SIZE_OUTPUT_BUFFER
#define control_UA_1_MAX_SIZE_OUTPUT_BUFFER 1000000UL
#endif
...
extern uaa_size control_UA_1_send(buffer_el msg[], outC_control* scade_ctx,
  extern_out_ctx_t* extern_out_ctx);

/* Receive notifications from the A661 server */
extern uaa_size control_UA_1_receive(buffer_el buffer[], uaa_size buffer_size,
  inC_control* scade_ctx, extern_in_ctx_t* extern_in_ctx);

/* Clear notifications */
extern void control_UA_1_receive_clear(inC_control* scade_ctx,
  extern_in_ctx_t* extern_in_ctx);


#endif /* _CONTROL_UA_1_H_ */

/*********************************************************
 ** End of file
 ** End of generation: 2017-10-18T23:50:55
 *********************************************************/
