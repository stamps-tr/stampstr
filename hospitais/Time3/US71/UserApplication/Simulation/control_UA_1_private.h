 ...
 *********************************************************/
#ifndef _CONTROL_UA_1_PRIVATE_H_
#define _CONTROL_UA_1_PRIVATE_H_ 
...
uaa_size a661_com_csp_widget_GpArcCircle(buffer_el msg[], uaa_uint16 wid, uaa_bool A661_FILL_INDEX__emit__, kcg_uint8 A661_FILL_INDEX_FillIndex_);

/* Functions to pack messages for layers */
uaa_size a661_com_layer_1(buffer_el msg[], outC_control* scade_ctx,  extern_out_ctx_t* extern_ctx);
#endif /* _CONTROL_UA_1_PRIVATE_H_ */
