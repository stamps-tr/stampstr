...
void Operator1(outC_Operator1 *outC)
{
  ...
  if (outC->init) {
    ...
    for (idx = 0; idx < 10000; idx++) {
      outC->fby_2.items[idx] = tmp;
    }
    outC->fby_2.idx = 0;
  }
  outC->_L11 = outC->fby_2.items[outC->fby_2.idx];
  ...
  outC->_L10 = kcg_false;
  outC->fby_2.items[outC->fby_2.idx] = outC->_L10;
  outC->fby_2.idx = (outC->fby_2.idx + 1) % 10000;
  outC->_L6 = kcg_true;
