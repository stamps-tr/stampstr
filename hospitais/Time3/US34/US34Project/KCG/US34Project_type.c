...
#ifdef __cplusplus
  #ifdef pSimarray_bool_100VTable_defined
    extern struct SimTypeVTable *pSimarray_bool_100VTable;
  #else 
    struct SimTypeVTable *pSimarray_bool_100VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimarray_bool_100VTable;
#endif

int array_bool_100_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimarray_bool_100VTable != NULL
        && pSimarray_bool_100VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimarray_bool_100VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnArrayToString(pValue, kcg_bool_to_string, 100, sizeof(kcg_bool), pfnStrAppend, pStrObj);
}

int check_array_bool_100_string(const char *str, char **endptr)
{
    static array_bool_100 rTemp;
    return string_to_array_bool_100(str, &rTemp, endptr);
}

int string_to_array_bool_100(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimarray_bool_100VTable != NULL) {
        nRet = string_to_VTable(str, pSimarray_bool_100VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToArray(str, pValue, &_Type_kcg_bool_Utils, 100, sizeof(kcg_bool), endptr);
    }
    return nRet;
}

int is_array_bool_100_double_conversion_allowed()
{
    if (pSimarray_bool_100VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimarray_bool_100VTable);
    }
    return 0;
}

int array_bool_100_to_double(const void *pValue, double *nValue)
{
    if (pSimarray_bool_100VTable != NULL) {
        return VTable_to_double(pValue, pSimarray_bool_100VTable, nValue);
    }
    return 0;
}

int is_array_bool_100_long_conversion_allowed()
{
    if (pSimarray_bool_100VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimarray_bool_100VTable);
    }
    return 0;
}

int array_bool_100_to_long(const void *pValue, long *nValue)
{
    if (pSimarray_bool_100VTable != NULL) {
        return VTable_to_long(pValue, pSimarray_bool_100VTable, nValue);
    }
    return 0;
}

void compare_array_bool_100(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimarray_bool_100VTable != NULL
        && pSimarray_bool_100VTable->m_version >= Scv612
        && pSimarray_bool_100VTable->m_pfnCompare != NULL) {
        if (pSimarray_bool_100VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimarray_bool_100VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimarray_bool_100VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnArrayComparison(pResult, pValue1, pValue2, 
                compare_kcg_bool, 100, sizeof(kcg_bool), pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_array_bool_100_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetArraySignature(get_kcg_bool_signature, 100, pfnStrAppend, pStrObj); 
}

int set_array_bool_100_default_value(void *pValue)
{
    int i;
    for (i = 0; i < 100; i++)
...
int init_array_bool_100(void *pValue)
{
    return 1;
}

int release_array_bool_100(void *pValue)
{
    return 1;
}

int copy_array_bool_100(void *pToValue, const void *pFromValue)
{
    kcg_copy_array_bool_100((array_bool_100*)pToValue, (array_bool_100*)pFromValue);
    return 1;
}

SimTypeUtils _Type_array_bool_100_Utils = {
    array_bool_100_to_string,
    check_array_bool_100_string,
    string_to_array_bool_100,
    is_array_bool_100_double_conversion_allowed,
    array_bool_100_to_double,
    is_array_bool_100_long_conversion_allowed,
    array_bool_100_to_long,
    compare_array_bool_100,
    get_array_bool_100_signature,
    set_array_bool_100_default_value,
    init_array_bool_100,
    release_array_bool_100,
    copy_array_bool_100,
    sizeof(array_bool_100)
};
...
#ifdef __cplusplus
  #ifdef pSimstruct_275VTable_defined
    extern struct SimTypeVTable *pSimstruct_275VTable;
  #else 
    struct SimTypeVTable *pSimstruct_275VTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimstruct_275VTable;
#endif

static SimFieldUtils struct_275_fields[] = {
    {"idx", offsetof(struct_275,idx), &_Type_kcg_size_Utils},
    {"items", offsetof(struct_275,items), &_Type_array_bool_100_Utils},
};

int struct_275_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimstruct_275VTable != NULL
        && pSimstruct_275VTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimstruct_275VTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnStructureToString(pValue, struct_275_fields, 2, pfnStrAppend, pStrObj);
}

int check_struct_275_string(const char *str, char **endptr)
{
    static struct_275 rTemp;
    return string_to_struct_275(str, &rTemp, endptr);
}

int string_to_struct_275(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimstruct_275VTable != NULL) {
        nRet = string_to_VTable(str, pSimstruct_275VTable, pValue, endptr);
    }
    if (nRet == 0) {
        nRet = pConverter->m_pfnStringToStructure(str, pValue, struct_275_fields, 2, endptr);
    }
    return nRet;
}

int is_struct_275_double_conversion_allowed()
{
    if (pSimstruct_275VTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimstruct_275VTable);
    }
    return 0;
}

int struct_275_to_double(const void *pValue, double *nValue)
{
    if (pSimstruct_275VTable != NULL) {
        return VTable_to_double(pValue, pSimstruct_275VTable, nValue);
    }
    return 0;
}

int is_struct_275_long_conversion_allowed()
{
    if (pSimstruct_275VTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimstruct_275VTable);
    }
    return 0;
}

int struct_275_to_long(const void *pValue, long *nValue)
{
    if (pSimstruct_275VTable != NULL) {
        return VTable_to_long(pValue, pSimstruct_275VTable, nValue);
    }
    return 0;
}

void compare_struct_275(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimstruct_275VTable != NULL
        && pSimstruct_275VTable->m_version >= Scv612
        && pSimstruct_275VTable->m_pfnCompare != NULL) {
        if (pSimstruct_275VTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimstruct_275VTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimstruct_275VTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        pConverter->m_pfnStructureComparison(pResult, pValue1, pValue2, struct_275_fields, 2, pTol, pszPath, pfnStrListAppend, pListErrPaths);
    }
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
}

int get_struct_275_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetStructureSignature(struct_275_fields, 2, pfnStrAppend, pStrObj);
}

int set_struct_275_default_value(void *pValue)
{
    set_kcg_size_default_value(&(((struct_275*)pValue)->idx));
    set_array_bool_100_default_value(&(((struct_275*)pValue)->items));
    return 1;
}

int init_struct_275(void *pValue)
{
    return 1;
}

int release_struct_275(void *pValue)
{
    return 1;
}

int copy_struct_275(void *pToValue, const void *pFromValue)
{
    kcg_copy_struct_275((struct_275*)pToValue, (struct_275*)pFromValue);
    return 1;
}

SimTypeUtils _Type_struct_275_Utils = {
    struct_275_to_string,
    check_struct_275_string,
    string_to_struct_275,
    is_struct_275_double_conversion_allowed,
    struct_275_to_double,
    is_struct_275_long_conversion_allowed,
    struct_275_to_long,
    compare_struct_275,
    get_struct_275_signature,
    set_struct_275_default_value,
    init_struct_275,
    release_struct_275,
    copy_struct_275,
    sizeof(struct_275)
