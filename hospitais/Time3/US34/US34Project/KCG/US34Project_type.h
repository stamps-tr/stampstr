#ifndef US34PROJECT_TYPES_CONVERSION
#define US34PROJECT_TYPES_CONVERSION
...
extern int set_array_bool_100_default_value(void *pValue);
...
#endif /*US34PROJECT_TYPES_CONVERSION */
