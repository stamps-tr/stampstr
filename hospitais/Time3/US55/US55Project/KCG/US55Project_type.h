#ifndef US55PROJECT_TYPES_CONVERSION
#define US55PROJECT_TYPES_CONVERSION
 ...
 ** array_bool_10000 
 ****************************************************************/
extern int array_bool_10000_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_array_bool_10000_string(const char *str, char **endptr);
extern int string_to_array_bool_10000(const char *str, void *pValue, char **endptr);
extern int is_array_bool_10000_double_conversion_allowed();
extern int array_bool_10000_to_double(const void *pValue, double *nValue);
extern int is_array_bool_10000_long_conversion_allowed();
extern int array_bool_10000_to_long(const void *pValue, long *nValue);
extern void compare_array_bool_10000(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_array_bool_10000_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_array_bool_10000_default_value(void *pValue);
extern int init_array_bool_10000(void *pValue);
extern int release_array_bool_10000(void *pValue);
extern int copy_array_bool_10000(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_array_bool_10000_Utils;
 ...
 ** struct_275 
 ****************************************************************/
extern int struct_275_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int check_struct_275_string(const char *str, char **endptr);
extern int string_to_struct_275(const char *str, void *pValue, char **endptr);
extern int is_struct_275_double_conversion_allowed();
extern int struct_275_to_double(const void *pValue, double *nValue);
extern int is_struct_275_long_conversion_allowed();
extern int struct_275_to_long(const void *pValue, long *nValue);
extern void compare_struct_275(int *nStatus, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths);
extern int get_struct_275_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj);
extern int set_struct_275_default_value(void *pValue);
extern int init_struct_275(void *pValue);
extern int release_struct_275(void *pValue);
extern int copy_struct_275(void *pToValue, const void *pFromValue);
extern SimTypeUtils _Type_struct_275_Utils;


#endif /*US55PROJECT_TYPES_CONVERSION */
